$(function(){
    ...
    // 최초실행 --------------------------------    
        ...
        //ajax 10개 출력.최초 데이터 불러오기

        $.ajax({
            url:"http://127.0.0.1:5500/0417/json/stu_score.json",
            data:"",
            type:"get",
            dataType:"json",
        ...
        $("#modifyBtn").click(function(){
            console.log("체크된 개수: "+$(".stuChk:checked").length);
            //1명만 선택
            if($(".stuChk:checked").length !=1){
        ...
        //선택된 체크의 데이터 가져오기
        //console.log("학번:   "+$(".stuChk:checked").parent().next().text());
