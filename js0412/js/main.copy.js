...
//최초실행-----------------------
    $(function(){
        ...
        // html소스를 tbody 추가
        $("#body").html(htmlData);   //기존 html 뒤쪽에 추가
        
        
        //최초실행____________________________
        ...
        $("#confirmBtn").click(function(){
            ...
            // html소스를 tbody 추가
            $("#body").prepend(htmlData);   //기존 html 뒤쪽에 추가
            
        });
           //$("#body").html(htmlData);    //기존 html에 덮어쓰기
           //$("#body").prepend(htmlData);   기존 html 위에 추가
           //$("#body").append(htmlData);   기존 html 뒤에 추가
        ...
        //하단 삭제버튼 클릭
        $("#deleteBtn").click(function(){     //check,change,keypress
            //alert("test")
        ...
        $(".stuChk").each(function(){
            ...
            if($(this).is(":checked")==true ){
                ...
                console.log("현재 선택된 id값: "+$(this).parent().parent().attr("id")).remove();
            }  //this는 자기자신
        }); //each
